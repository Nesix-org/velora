    ...
    <div className="border-t-24 border-bgLemon ml-[2rem] min-w-[500px] md:w-[700px] lg:w-[1280px] max-w-7xl md:mx-auto flex flex-col items-center justify-center min-h-screen py-8 text-bgGray px-4 dark:bg-gray-900 dark:text-white rounded-lg">
      ...
      <div className="mt-10 max-w-3xl text-center mb-20">
        ...
        <p className="text-xl md:text-2xl mt-4">
          Items purchases on Velora are subject to our standard return policy
          unless otherwise stated. Please review our return policy for detailed
          information on eligibility, timeframes, and procedures for returning
          items.
        </p>
      </div>
      ...
      <div className="max-w-3xl text-center mb-20">
        ...
        <p className="text-xl md:text-2xl">
          ...
          how we collect, use, and protect your personal information while you
          shop on Velora.
        </p>
      </div>
    </div>
